...
class _ReviewsScreenState extends State<ReviewsScreen> {
  ...
  final List<_Review> _reviews = [
    _Review(
      ...
      date: '2 days ago',
      text:
          'Absolutely stunning place! The staff was incredibly friendly and the views were breathtaking. Will definitely visit again on my next trip to Sri Lanka.',
      reply: null,
    ),
    _Review(
      id: 'r2',
      ...
      date: '1 week ago',
      text:
          'Great experience overall. The flash offer we found was amazing value. Only minor issue was parking.',
      reply:
          'Thank you James! We\'re working on improving the parking situation. Hope to see you again!',
    ),
    _Review(
      id: 'r3',
      name: 'Yuki Tanaka',
      ...
      date: '2 weeks ago',
      text:
          'Perfect for sunset watching. The location is simply magical and very photogenic.',
      reply: null,
    ),
    _Review(
      id: 'r4',
      ...
      date: '3 weeks ago',
      text:
          'Decent spot but gets very crowded on weekends. Better to visit on weekdays for a more peaceful experience.',
      reply: null,
    ),
    _Review(
      id: 'r5',
      ...
      date: '1 month ago',
      text:
          'One of the best places I visited in my South Sri Lanka tour. Highly recommend the morning visit.',
      reply:
          'Thank you Arjun! Morning is indeed the best time — glad you enjoyed it!',
    ),
  ];
  ...
  List<_Review> get _filtered {
    ...
    if (_filter == 'Replied')
      return _reviews.where((r) => r.reply != null).toList();
    if (_filter == 'Pending')
      return _reviews.where((r) => r.reply == null).toList();
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        // Right column (avg rating) — FIXED: added mainAxisSize.min + FittedBox
                        Column(
                          mainAxisAlignment: MainAxisAlignment.end,
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate((context, index) {
                ...
                return _ReviewCard(
                  review: r,
                  index: index,
                  onReply: (text) => setState(() => r.reply = text),
                );
